...
const navigation = [
  { name: 'Superbase', href: 'https://app.supabase.com/' },
  { name: 'All Data', href: '/dataCapture' },
//   { name: 'Marketplace', href: '#' },
//   { name: 'Company', href: '#' },
]

export default function NavBarEg() {
  return (
	
    <div className="relative overflow-hidden h-30 justify-between">
            ...
            <div className="relative px-4 pt-6 sm:px-6 lg:px-8">
              <nav className="relative flex items-center justify-between lg:justify-start" aria-label="Global">
                ...
                <div className="hidden md:ml-10 md:block md:space-x-8 md:pr-4">
				  ...
				  {/* <Link href="/dataCapture"  className="font-medium text-gray-500 hover:text-gray-900">
                      All Data
                    </Link > */}
